// Separate module so developer tools and their dependencies never enter the
// service's go.mod. Versions are pinned here and in go.sum; `make tools`
// builds them into ../bin.
module github.com/isasumer/go-react-calculator/backend/tools
